...
namespace Maps
{
	public class FavoriteCheck : Button
	{
		public FavoriteCheck()
		{
			base.Image = "star_marked.png";
		...
		public static BindableProperty CheckedProperty = BindableProperty.Create(
			...
			declaringType: typeof(FavoriteCheck),
			defaultValue: null,
		...
		private static void CheckedValueChanged(BindableObject bindable, object oldValue, object newValue)
		{
			...
			{
				((FavoriteCheck)bindable).Image = "star_marked.png";
			}
			else
			{
				((FavoriteCheck)bindable).Image = "star_unmarked.png";
			}
		}
